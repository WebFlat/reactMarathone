...
function App() {
  return (
    <>
        ...
        <Layout id="cards" title="Cards" colorBg="#eeee" titleColor="#FEFEFE">
          <div className={s.flex}>
              {
                POKEMONS.map((item) => <PokemonCard key={item.id} id={item.id} type={item.type} name={item.name} img={item.img} values={item.values} />)
              }
          </div>
        </Layout>  
        <Footer />
